...
const Home: NextPage = () => {
  ...
  return (
    ...
    <Flex justifyContent="center">
      <Button onClick={toClassify} fontWeight={900} fontSize="15pt" height="70px" width="250px"color="white" bg="linear-gradient(to right, #b993d6, #8ca6db)">Classify my Watch!</Button>
    </Flex>
    </>
  )
}
